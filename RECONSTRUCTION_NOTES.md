...
- `bout_users.password` is `varchar(40)`, so auth stores SHA1 hashes for register/change-password compatibility.
- Login accepts plain, SHA1, or MD5 legacy password formats.
