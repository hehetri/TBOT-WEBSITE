...
<title>Event T-Bot Online Indonesia - T-Bot Online</title> 
...
<div style="background-image: url(../images/cbt/header_back.jpg); background-repeat: no-repeat; background-position: center top; width: 100%; position:relative;display: table;">
	<div style="width: 100%;height: 34px;background-image: url(../images/back.jpg);background-repeat: repeat-x;position: fixed; top: 0px; z-index:9999;">
		<div style="background-image: url(../images/back.jpg); background-repeat: no-repeat; width: 1005px; height: 34px; z-index:1; left: 0px;margin: 0 auto 0 auto ; position:relative ">
			...
			<div style="background-image: url(../images/messege_icon.png); background-repeat: no-repeat; width: 26px; height: 26px; position: absolute; top: 3px; left: 660px;;cursor: pointer;" onclick="jsRedirectTo(&quot;mailto:tbotsupport@orangegame.co.id&quot;)"></div>
			<script>
/*<![CDATA[*/
...
<div id="login_panel" style="background-image: url(../images/back_signup.png); background-repeat: no-repeat; width: 292px; height: 138px; position: absolute; top: -90px; left: 695px; z-index:2;" onmouseover="doani(true)" onmouseout="doani(false)" onfocus="aniStopScroll(true)" onblur="aniStopScroll(false)" tabindex="0">
	...
	<form id="frm_login" name="frm_login" method="post" action="../auth/login.php" onsubmit="return(js2test(this.id))">
...
<div>
	...
	<div class="c_box_big_header">
		<div class="c_title" style="background-image: url(../images/obt/event01/event_tbot.png); width: 308px; height: 17px;">
		</div>
	</div>
	<div class="c_box_big_content_outer">
		<div class="c_box_big_content_inner">
			...
			<div class="c_box_big_content_wrapper">
				<!-- content here -->
				<div style="background-image: url(../images/obt/event01/banner.jpg); width: 630px; height: 343px; margin-left: auto; margin-right: auto; margin-bottom: 10px;"></div>

				<div style="background-image: url(../images/obt/event01/btn_daftar_level10.png); width: 594px; height: 57px; margin-left: auto; margin-right: auto; margin-bottom: 10px; cursor: pointer;" onclick="jsRedirectTo(&quot;/eventidregister&quot;)"></div>

				<div style="font-size: 9pt; font-family:Arial;line-height: 20px;" align="Justify">
					<p>Dengan janji kita sebelumnya jika fanpage Like T-Bot online Indonesia sampai di angka 5000, maka Crew T-Bot akan membuat event berhadiah iPod  4G. Maka kami mengajak para Meccamania untuk bergabung di fanpage dan Game kami untuk mengikuti Event <b>"Play and Win"</b>.</p>

					<p>Untuk Event kali ini kita Crew T-Bot akan mengeluarkan event <b>"Play and Win"</b>, caranya mudah untuk mengikuti Event ini. Anda Cukup dengan  Meregistrasi  ID di www.orangegame.co.id dan mainkan  ID T-bot anda hingga mencapai Level 10. dan langsung daftarkan ID anda yang sudah mencapai level 10 di website tbot.orangegame.co.id</p>

					<p>Crew T-Bot akan melakukan keabsahan terhadap ID yang sudah terdaftar di website tbot.orangegame.co.id.  Apabila terjadi kecurangan atau tindakan yang tidak sesuai dengan peraturan, Maka Crew T-Bot berhak sepenuhnya untuk mendiskualifikasi ID tersebut.</p>

					<p>Hadiah Event <b>"Play and Win"</b>: <b>Ipod touch 4G</b>.</p>

					<p>
					<b>Cara Mengikuti Event.</b>
					</p><ol>
					<li>Register ID OrangeGame:  Bagi kamu yang belum daftar ID di OrangeGame klik Register akan menuju ke halaman registrasi. Lakukanlah registrasi di halaman ini dengan mengisi semua data-datamu agar bisa memainkan semua game yang ada di OrangeGame.</li>
					<li>Download Game T-Bot: Agar bisa memainkan game T-Bot kamu bisa download client gamenya klik disini apabila internet kamu koneksinya kurang bagus kamu bisa download secara bertahap disini <a style="text-decoration: underline;" href="../downloads/index.php">1</a> <a style="text-decoration: underline;" href="../downloads/index.php">2</a> <a style="text-decoration: underline;" href="../downloads/index.php">3</a> <a style="text-decoration: underline;" href="../downloads/index.php">4</a> <a style="text-decoration: underline;" href="../downloads/index.php">5</a> <a style="text-decoration: underline;" href="../downloads/index.php">6</a> <a style="text-decoration: underline;" href="../downloads/index.php">7</a> <a style="text-decoration: underline;" href="../downloads/index.php">8</a> <a style="text-decoration: underline;" href="../downloads/index.php">9</a> <a style="text-decoration: underline;" href="../downloads/index.php">10</a> <a style="text-decoration: underline;" href="../downloads/index.php">11</a> setelah selesai terdownload semuanya langsung extract agar menjadi file yang utuh. Setelah berhasil kamu bisa langsung Install dan mainkan gamenya sampai Level 10, untuk tahu caranya bisa klik di <a style="text-decoration: underline;" href="../gameinfo/newbie/index.php">sini</a></li>
					<li>Daftar ID T-Bot Level 10: Apabila T-Bot'mu sudah level 10 segera daftarkan IDmu di <a style="text-decoration: underline;" href="../eventidregister/index.php">sini</a> atau kunjungi website T-Bot <a style="text-decoration: underline;" href="../eventidregister/index.php">tbot.orangegame.co.id/eventidregister</a></li>
					</ol>
					<p></p>
					...
					<b>Cara Pengundian.</b>
						...
						<li>Crew T-Bot akan mencatat semua nama user yang sudah mendaftarkan ID di event <b>"Play and Win"</b>.</li>
						<li>Crew T-Bot akan mengundi secara Random Winner untuk menentukan pemenangnya.</li>
						<li>Crew T-Bot akan memberitahu pemenang melalui  fanpage T-Bot online Indonesia dan forum T-Bot online Indonesia.</li>
					</ul>
					<p></p>
					<p>
					<b>Syarat dan Ketentuan.</b>
					</p><ul>
						<li>Meccamania  tidak diperkenankan berkomentar atau membuat ID yang   mengandung unsur SARA, pornografi dan melanggar norma kesusilaan, menjatuhkan, merusak nama baik, mengancam, melecehkan atau menghina orang lain, menyarankan tindakan melanggar hukum atau berdiskusi yang mengarah pada tindakan melanggar hukum. Bahwa pelanggaran yang dilakukan atas ketentuan ini menjadi tanggung jawab hukum dari masing-masing pihak yang melakukan hal tersebut.</li>
						<li>Event berhadiah ini diperuntukkan untuk peserta yang  telah mendaftarkan idnya di website T-BoT Online Indonesia.</li>
						<li>1 (satu) ID T-Bot  hanya diperbolehkan mendaftar 1 (satu) kali dalam event ini.</li>
						<li>Crew T-Bot  berhak menghapus  atau mendiskualifikasi ID yang mengandung dalam point  pertama.</li>
						<li>Pemenang event <b>"Play and Win"</b> diharuskan datang langsung ke kantor orangegame untuk menerima hadiahnya atau bisa diwakilkan.</li>
						<li>Keputusan Crew T-Bot tidak dapat diganggu gugat.</li>
