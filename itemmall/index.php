...
<title>Item Mall - New - T-Bot Online</title> 
...
<div id="login_panel" onmouseover="doani(true)" onmouseout="doani(false)" onfocus="aniStopScroll(true)" onblur="aniStopScroll(false)" tabindex="0">
	...
	<div class="submenu_inner">
		<div id="im_submenu_cat_new" class="im_submenu_item im_submenu_cat_new  im_submenu_cat_new_over" onmouseover="jsOverToggler(&quot;im_submenu_cat_new&quot;, &quot;im_submenu_cat_new_over&quot;, true)" onmouseout="jsOverToggler(&quot;im_submenu_cat_new&quot;, &quot;im_submenu_cat_new_over&quot;, true)"></div>
		...
		<div id="im_submenu_cat_acc" class="im_submenu_item im_submenu_cat_acc " onclick="jsRedirectTo('acc')" onmouseover="jsOverToggler(&quot;im_submenu_cat_acc&quot;, &quot;im_submenu_cat_acc_over&quot;)" onmouseout="jsOverToggler(&quot;im_submenu_cat_acc&quot;, &quot;im_submenu_cat_acc_over&quot;)"></div>
...
<div class="c_box_big_outer">
	<div class="c_box_big_header">
		<div class="c_title im_title_new">
		</div>
	...
	<div class="c_box_big_content_outer">
		<div class="c_box_big_content_inner">
			...
			<div class="c_box_big_content_wrapper">
				...
				<tbody><tr>
<td>
	<table id="im_item_40" class="im_item_panel im_item_panel_border_1" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
			<div id="im_item_panel_image_40" class="im_item_panel_image" style="background-image: url(../images/itemmall/MPAK_Colossus.jpg);">
				<div class="im_img_ef"></div>
						<div class="im_img_newitem"></div>
					</div>
		</td>
		<td width="113px" style="vertical-align: top;">
			<div class="im_item_panel_item_name">Colossus</div>
					1 Hari : <span class="im_item_panel_use_time">259</span><br>
					7 Hari : <span class="im_item_panel_use_time">777</span><br>
					30 Hari : <span class="im_item_panel_use_time">1554</span><br>
					<br>
			Type: MercPack		</td>
	</tr>
	</tbody></table>
	<div dojotype="dijit.Tooltip" connectid="im_item_panel_image_40" position="below" style="display: none;">
		Sangat berguna dalam segala kondisi, baik untuk menyerang atau bertahan.	</div>
</td><td>
	...
	<table id="im_item_33" class="im_item_panel im_item_panel_border_0" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
			<div id="im_item_panel_image_33" class="im_item_panel_image" style="background-image: url(../images/itemmall/HEAD_Goldknight.jpg);">
				<div class="im_img_ef"></div>
						<div class="im_img_newitem"></div>
					</div>
		</td>
		<td width="113px" style="vertical-align: top;">
			<div class="im_item_panel_item_name">Goldknight</div>
	...
	<div dojotype="dijit.Tooltip" connectid="im_item_panel_image_33" position="below" style="display: none;">
		GoldKnight merupakan sebuah lambang kehormatan.	</div>
</td></tr><tr><td>
	<table id="im_item_37" class="im_item_panel im_item_panel_border_1" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
	...
	<table id="im_item_39" class="im_item_panel im_item_panel_border_2" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
	...
	<table id="im_item_36" class="im_item_panel im_item_panel_border_0" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
			<div id="im_item_panel_image_36" class="im_item_panel_image" style="background-image: url(../images/itemmall/TPAK_Overrunner.jpg);">
				<div class="im_img_ef"></div>
						<div class="im_img_newitem"></div>
					</div>
		</td>
		<td width="113px" style="vertical-align: top;">
			<div class="im_item_panel_item_name">Overrunner</div>
					1 Hari : <span class="im_item_panel_use_time">600</span><br>
					7 Hari : <span class="im_item_panel_use_time">1800</span><br>
					30 Hari : <span class="im_item_panel_use_time">3600</span><br>
					<br>
			Type: TransPack		</td>
	</tr>
	</tbody></table>
	<div dojotype="dijit.Tooltip" connectid="im_item_panel_image_36" position="below" style="display: none;">
		Setelah menggunakan item ini, dapat transform menjadi Overrunner.	</div>
</td></tr><tr><td>
	<table id="im_item_34" class="im_item_panel im_item_panel_border_1" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
			<div id="im_item_panel_image_34" class="im_item_panel_image" style="background-image: url(../images/itemmall/HEAD_Satan.jpg);">
				<div class="im_img_ef"></div>
						<div class="im_img_newitem"></div>
					</div>
		</td>
		<td width="113px" style="vertical-align: top;">
			<div class="im_item_panel_item_name">Satan</div>
					1 Hari : <span class="im_item_panel_use_time">325</span><br>
					7 Hari : <span class="im_item_panel_use_time">975</span><br>
					30 Hari : <span class="im_item_panel_use_time">1950</span><br>
					<br>
			Type: Head		</td>
	</tr>
	</tbody></table>
	<div dojotype="dijit.Tooltip" connectid="im_item_panel_image_34" position="below" style="display: none;">
		Kamu ingin membuat musuh ketakutan? Gunakan Head Part ini.	</div>
</td><td>
	<table id="im_item_35" class="im_item_panel im_item_panel_border_2" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
			<div id="im_item_panel_image_35" class="im_item_panel_image" style="background-image: url(../images/itemmall/TPAK_SuperKhanZ.jpg);">
				<div class="im_img_ef"></div>
						<div class="im_img_newitem"></div>
					</div>
		</td>
		<td width="113px" style="vertical-align: top;">
			<div class="im_item_panel_item_name">SuperKhanZ</div>
					1 Hari : <span class="im_item_panel_use_time">665</span><br>
					7 Hari : <span class="im_item_panel_use_time">1995</span><br>
					30 Hari : <span class="im_item_panel_use_time">3990</span><br>
					<br>
			Type: TransPack		</td>
	</tr>
	</tbody></table>
	<div dojotype="dijit.Tooltip" connectid="im_item_panel_image_35" position="below" style="display: none;">
		Setelah menggunakan item ini, dapat transform menjadi SuperKhanZ.	</div>
</td><td><table class="im_item_panel im_item_panel_border_0"><tbody><tr><td></td></tr></tbody></table></td>	</tr><tr>
...
<tbody><tr>
	<td width="25px">
	<!-- First page link -->
			<div class="im_nav_left_ff" onclick="jsRedirectTo(&quot;/itemmall/index/page/1&quot;)"></div>
		</td>
	<td width="25px">
	<!-- Previous page link -->
		</td>
	...
	<td width="25px"> 
	<!-- Last page link -->
			<div class="im_nav_right_ff" onclick="jsRedirectTo(&quot;/itemmall/index/page/1&quot;)"></div>
		</td>
</tr>
</tbody></table>
	</div>
