...
&nbsp;<span class="im_cat_link_seperator">|</span>&nbsp;				<a class="im_cat_link" href="../9/index.php">
				Aura				</a>
&nbsp;<span class="im_cat_link_seperator">|</span>&nbsp;				<span class="im_cat_link_disabled">FloatGun</span>
...
&nbsp;<span class="im_cat_link_seperator">|</span>&nbsp;				<a class="im_cat_link" href="../13/index.php">
				...
				<tbody><tr>
<td>
	<table id="im_item_21" class="im_item_panel im_item_panel_border_1" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
			<div id="im_item_panel_image_21" class="im_item_panel_image" style="background-image: url(../../../../images/itemmall/FGUN_Megaspark.jpg);">
				<div class="im_img_ef"></div>
					</div>
		</td>
		<td width="113px" style="vertical-align: top;">
			<div class="im_item_panel_item_name">Megaspark</div>
					20x: <span style="color: #86150f;">500</span><br>
					100x: <span style="color: #86150f;">1500</span><br>
					<br>
			Type: FloatGun		</td>
	</tr>
	</tbody></table>
	<div dojotype="dijit.Tooltip" connectid="im_item_panel_image_21" position="below" style="display: none;">
		Senjata dengan bentuk yang sangat besar, memiliki serangan kuat. Damage: 120.	</div>
</td><td>
	<table id="im_item_22" class="im_item_panel im_item_panel_border_2" border="0" cellspacing="0px" cellpadding="0px">
	<tbody><tr>
		<td width="80px" style="vertical-align: top;">
			<div id="im_item_panel_image_22" class="im_item_panel_image" style="background-image: url(../../../../images/itemmall/FGUN_SpiritGun.jpg);">
				<div class="im_img_ef"></div>
					</div>
		</td>
		<td width="113px" style="vertical-align: top;">
			<div class="im_item_panel_item_name">SpiritGun</div>
					20x: <span style="color: #86150f;">500</span><br>
					100x: <span style="color: #86150f;">1500</span><br>
					<br>
			Type: FloatGun		</td>
	...
	<div dojotype="dijit.Tooltip" connectid="im_item_panel_image_22" position="below" style="display: none;">
		SpiritGun mempunyai daya serang yang kuat. Damage: 130.	</div>
...
<tbody><tr>
	<td width="25px">
	<!-- First page link -->
			<div class="im_nav_left_ff" onclick="jsRedirectTo(&quot;/itemmall/acc/category/10/page/1&quot;)"></div>
		</td>
	<td width="25px">
	<!-- Previous page link -->
		</td>
	...
	<td width="25px"> 
	<!-- Last page link -->
			<div class="im_nav_right_ff" onclick="jsRedirectTo(&quot;/itemmall/acc/category/10/page/1&quot;)"></div>
		</td>
</tr>
</tbody></table>
	</div>
