...
<title>Download - T-Bot Online</title> 
...
<div style="background-image: url(../images/cbt/header_back.jpg); background-repeat: no-repeat; background-position: center top; width: 100%; position:relative;display: table;">
	...
	<div id="oToolbarContainer" style="width: 1005px;">
		<div id="oToolbarMainContainer">
			...
			<div id="oToolbarBtnMS" onclick="jsOpenWin(&quot;http://mystic.orangegame.co.id&quot;)"></div>
...
<div>
	...
	<div class="c_box_big_header">
		<div class="c_title c_full_client_title">
		</div>
	</div>
		...
		<div class="c_box_big_content_inner">
			...
			<div class="c_box_big_content_wrapper">
				...
				<div style="margin-top: 10px;">
					...
					<tbody><tr>
						<td>
							<img src="../images/icon_new_large.png" border="0">
						</td>
						<td class="txt_version">
							Client ini sudah menggunakan icon terbaru, apabila Anda masih menggunakan<br>
							Icon yang lama, silahkan download icon baru <a href="icon/index.php">Klik Disini</a>
						</td>
					</tr>
					</tbody></table>
				</div>
...
<div class="c_box_big_outer">
	<!-- patch start -->
	<div class="c_box_big_header">
		<div class="c_title c_patch_title">
		</div>
	</div>
	<div class="c_box_big_content_outer">
		<div class="c_box_big_content_inner">
...
<div class="c_box_big_outer">
	...
	<div class="c_box_big_header">
		<div class="c_title c_partial_title"></div>
	</div>
	<div class="c_box_big_content_outer">
		<div class="c_box_big_content_inner">
			<div class="c_box_big_left"></div>
...
<div class="c_box_big_outer">
	<!-- mirrors start -->
	<div class="c_box_big_header">
		<div class="c_title c_mirrors_title"></div>
	</div>
	<div class="c_box_big_content_outer">
		<div class="c_box_big_content_inner">
			<div class="c_box_big_left"></div>
...
<div class="c_box_big_outer">
	<!-- requirement start -->
	<div class="c_box_big_header">
		<div class="c_title c_requirement_title"></div>
	</div>
	<div class="c_box_big_content_outer">
		<div class="c_box_big_content_inner">
			<div class="c_box_big_left"></div>
