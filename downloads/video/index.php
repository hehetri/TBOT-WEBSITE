...
<title>Download - Video - T-Bot Online</title> 
<link href="../../images/favicon.ico" rel="shortcut icon">
<link href="../../css/main.css" media="screen" rel="stylesheet" type="text/css">
<link href="../../css/cbt2.css" media="screen" rel="stylesheet" type="text/css"><script type="text/javascript" src="../../lib/swfobject/swfobject.js"></script>
...
<div>
	...
	<div class="c_box_big_header">
		<div class="c_title c_dl_video_title">
		</div>
	</div>
		...
		<div class="c_box_big_content_inner">
			...
			<div class="c_box_big_content_wrapper">
				...
				<script type="text/javascript">
					...
					var flashvars = {};
					flashvars.xmlFile = "/xml/data.xml"; // SET XML FILE HERE
					var params = {};
					...
					swfobject.embedSWF("/objects/preview.swf", "alternativeContent", "640", "370", "9.0.0", false, flashvars, params, attributes);
				</script>
				<div id="alternativeContent" style="z-index: -1;">
