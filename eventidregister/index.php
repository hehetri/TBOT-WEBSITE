...
<title>Belum registrasi - T-Bot Online</title> 
...
<div style="background-image: url(../images/cbt/header_back.jpg); background-repeat: no-repeat; background-position: center top; width: 100%; position:relative;display: table;">
	<div id="oToolbarContainer">
		<div id="oToolbarMainContainer">
			...
			<div id="oToolbarBtn81" onclick="jsOpenWin(&quot;http://81keys.orangegame.co.id&quot;)"></div>
...
Anda belum login atau belum registrasi<br>
Untuk registrasi klik di <a href="../register.php" target="_blank" style="font-weight: bold;">sini</a>.
</div>						</div>
					</div>
				</div>
			</div>
